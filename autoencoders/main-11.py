...
# df = pd.read_pickle('./../motivation-example/goodBadPlates_10_color_500_000_plates.pkl')
...
for S in scaling:
    for LOSS_FN in loss_functions:
        for ACTIVATION_FN in activation_functions:
            ...
            autoencoder.add(
                Dense(4 * encoding_dim, input_shape=(input_dim,), activation=ACTIVATION_FN)
            )
            autoencoder.add(
            ...
            # plt.show()
            fig.savefig("./images/10c/good_bad_plates_autoencoded_dimensions_{}_{}_{}_{}.png".format(NAME, S, LOSS_FN, ACTIVATION_FN))
            plt.close('all')
