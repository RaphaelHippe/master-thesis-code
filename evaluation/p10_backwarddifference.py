...
X0['diameter'] = scaler.fit_transform(X0['diameter'].values.reshape([-1,1]))
...
# np.savetxt('./acc/p10-backwardDifference-knn-MaxAbsScaler.txt', acc_scores_knn, fmt='%1.3f')
# # RFC
...
# np.savetxt('./acc/p10-backwardDifference-rfc-MaxAbsScaler.txt', acc_scores_rfc, fmt='%1.3f')
# # GNB
...
# np.savetxt('./acc/p10-backwardDifference-gnb-MaxAbsScaler.txt', acc_scores_gnb, fmt='%1.3f')
#
#
# # F1 score
...
# np.savetxt('./f1/p10-backwardDifference-knn-MaxAbsScaler.txt', f1_scores_knn, fmt='%1.3f')
# # RFC
...
# np.savetxt('./f1/p10-backwardDifference-rfc-MaxAbsScaler.txt', f1_scores_rfc, fmt='%1.3f')
# # GNB
...
# np.savetxt('./f1/p10-backwardDifference-gnb-MaxAbsScaler.txt', f1_scores_gnb, fmt='%1.3f')
