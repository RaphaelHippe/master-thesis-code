...
df = pd.read_csv('./../datasets/autoencoded-p100_1/p100_1_not_scaled_cosine_proximity_tanh_1.csv')
print(df.head())
y = df['y']
X = df.drop(['y', 'Unnamed: 0'], axis=1)

features = [['0', '1', '2', '3'], 'diameter']
...
np.savetxt('./acc/p100-auto-1-not-scaled-cosine-proximity-tanh-1-knn.txt', acc_scores_knn, fmt='%1.3f')
# RFC
...
np.savetxt('./acc/p100-auto-1-not-scaled-cosine-proximity-tanh-1-rfc.txt', acc_scores_rfc, fmt='%1.3f')
# GNB
...
np.savetxt('./acc/p100-auto-1-not-scaled-cosine-proximity-tanh-1-gnb.txt', acc_scores_gnb, fmt='%1.3f')
...
np.savetxt('./f1/p100-auto-1-not-scaled-cosine-proximity-tanh-1-knn.txt', f1_scores_knn, fmt='%1.3f')
# RFC
...
np.savetxt('./f1/p100-auto-1-not-scaled-cosine-proximity-tanh-1-rfc.txt', f1_scores_rfc, fmt='%1.3f')
# GNB
...
np.savetxt('./f1/p100-auto-1-not-scaled-cosine-proximity-tanh-1-gnb.txt', f1_scores_gnb, fmt='%1.3f')
