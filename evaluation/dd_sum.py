...
np.savetxt('./acc/dd-sum-knn.txt', acc_scores_knn, fmt='%1.3f')
# RFC
...
np.savetxt('./acc/dd-sum-rfc.txt', acc_scores_rfc, fmt='%1.3f')
# GNB
...
np.savetxt('./acc/dd-sum-gnb.txt', acc_scores_gnb, fmt='%1.3f')
...
np.savetxt('./f1/dd-sum-knn.txt', f1_scores_knn, fmt='%1.3f')
# RFC
...
np.savetxt('./f1/dd-sum-rfc.txt', f1_scores_rfc, fmt='%1.3f')
# GNB
...
np.savetxt('./f1/dd-sum-gnb.txt', f1_scores_gnb, fmt='%1.3f')
