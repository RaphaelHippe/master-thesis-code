...
features = ['x1','x2','x3','x4','x12','x13','x14','x15','x16',
            'x23','x24','x26','x27',
            ['x5_0', 'x5_1','x5_2','x5_3','x5_4', 'x5_5', 'x5_6'],
            ['x6_0', 'x6_1'],
            ['x7_0', 'x7_1'],
            ['x8_0', 'x8_1'],
            ['x9_0', 'x9_1'],
...
np.savetxt('./acc/dd-binary-knn.txt', acc_scores_knn, fmt='%1.3f')
# RFC
...
np.savetxt('./acc/dd-binary-rfc.txt', acc_scores_rfc, fmt='%1.3f')
# GNB
...
np.savetxt('./acc/dd-binary-gnb.txt', acc_scores_gnb, fmt='%1.3f')
...
np.savetxt('./f1/dd-binary-knn.txt', f1_scores_knn, fmt='%1.3f')
# RFC
...
np.savetxt('./f1/dd-binary-rfc.txt', f1_scores_rfc, fmt='%1.3f')
# GNB
...
np.savetxt('./f1/dd-binary-gnb.txt', f1_scores_gnb, fmt='%1.3f')
