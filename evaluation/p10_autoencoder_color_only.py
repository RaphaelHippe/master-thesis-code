...
np.savetxt('./acc/p10-auto-1-not-scaled-cosine-proximity-tanh-1-knn.txt', acc_scores_knn, fmt='%1.3f')
# RFC
...
np.savetxt('./acc/p10-auto-1-not-scaled-cosine-proximity-tanh-1-rfc.txt', acc_scores_rfc, fmt='%1.3f')
# GNB
...
np.savetxt('./acc/p10-auto-1-not-scaled-cosine-proximity-tanh-1-gnb.txt', acc_scores_gnb, fmt='%1.3f')
...
np.savetxt('./f1/p10-auto-1-not-scaled-cosine-proximity-tanh-1-knn.txt', f1_scores_knn, fmt='%1.3f')
# RFC
...
np.savetxt('./f1/p10-auto-1-not-scaled-cosine-proximity-tanh-1-rfc.txt', f1_scores_rfc, fmt='%1.3f')
# GNB
...
np.savetxt('./f1/p10-auto-1-not-scaled-cosine-proximity-tanh-1-gnb.txt', f1_scores_gnb, fmt='%1.3f')
