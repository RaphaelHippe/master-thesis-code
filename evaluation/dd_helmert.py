...
np.savetxt('./acc/dd-helmert-knn.txt', acc_scores_knn, fmt='%1.3f')
# RFC
...
np.savetxt('./acc/dd-helmert-rfc.txt', acc_scores_rfc, fmt='%1.3f')
# GNB
...
np.savetxt('./acc/dd-helmert-gnb.txt', acc_scores_gnb, fmt='%1.3f')
...
np.savetxt('./f1/dd-helmert-knn.txt', f1_scores_knn, fmt='%1.3f')
# RFC
...
np.savetxt('./f1/dd-helmert-rfc.txt', f1_scores_rfc, fmt='%1.3f')
# GNB
...
np.savetxt('./f1/dd-helmert-gnb.txt', f1_scores_gnb, fmt='%1.3f')
