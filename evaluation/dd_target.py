...
np.savetxt('./acc/dd-target-knn.txt', acc_scores_knn, fmt='%1.3f')
# RFC
...
np.savetxt('./acc/dd-target-rfc.txt', acc_scores_rfc, fmt='%1.3f')
# GNB
...
np.savetxt('./acc/dd-target-gnb.txt', acc_scores_gnb, fmt='%1.3f')
...
np.savetxt('./f1/dd-target-knn.txt', f1_scores_knn, fmt='%1.3f')
# RFC
...
np.savetxt('./f1/dd-target-rfc.txt', f1_scores_rfc, fmt='%1.3f')
# GNB
...
np.savetxt('./f1/dd-target-gnb.txt', f1_scores_gnb, fmt='%1.3f')
