...
df = pd.read_csv('./../datasets/autoencoded-p100_1/p100_1_not_scaled_cosine_proximity_tanh_1_new.csv')
y = df['y']
...
df = pd.read_csv('./../datasets/autoencoded-p100/p100_100c_150_not_scaled_categorical_crossentropy_sigmoid_new.csv')
y = df['y']
X = df.drop(['y', 'Unnamed: 0'], axis=1)
...
df = pd.read_csv('./../datasets/dummy_pca/p100/p100_n2_new.csv')
dfy = pd.read_csv('./../datasets/plates_100_new.csv')
y = dfy['goodPlate']
X = df.drop(['Unnamed: 0'], axis=1)
features = ['pc0', 'pc1']
results.append(doAccuracyTests(X, y, 'pca2'))

df = pd.read_csv('./../datasets/dummy_pca/p100/p100_n11_new.csv')
dfy = pd.read_csv('./../datasets/plates_100_new.csv')
y = dfy['goodPlate']
X = df.drop(['Unnamed: 0'], axis=1)
...
df.to_csv('./acc/p100_cv50_other methods_new.csv')
