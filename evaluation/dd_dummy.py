...
features = ['x1','x2','x3','x4','x12','x13','x14','x15','x16','x23','x24','x26','x27',
            ['x5_ak47','x5_aug','x5_awp','x5_bizon','x5_cz75a','x5_deagle','x5_decoy_projectile','x5_elite','x5_famas','x5_fiveseven','x5_flashbang','x5_g3sg1','x5_galilar','x5_glock','x5_hegrenade','x5_hkp2000','x5_inferno','x5_knife','x5_m4a1','x5_m4a1_silencer','x5_mac10','x5_mag7','x5_molotov_projectile','x5_mp7','x5_mp9','x5_nova','x5_p250','x5_p90','x5_scar20','x5_sg556','x5_smokegrenade','x5_ssg08','x5_taser','x5_tec9','x5_ump45','x5_usp_silencer','x5_xm1014'],
            ['x7_Counter Terrorist', 'x7_Terrorist'],
            ['x17_Counter Terrorist', 'x17_Terrorist']
]
...
np.savetxt('./acc/dd-dummy-knn.txt', acc_scores_knn, fmt='%1.3f')
# RFC
...
np.savetxt('./acc/dd-dummy-rfc.txt', acc_scores_rfc, fmt='%1.3f')
# GNB
...
np.savetxt('./acc/dd-dummy-gnb.txt', acc_scores_gnb, fmt='%1.3f')
...
np.savetxt('./f1/dd-dummy-knn.txt', f1_scores_knn, fmt='%1.3f')
# RFC
...
np.savetxt('./f1/dd-dummy-rfc.txt', f1_scores_rfc, fmt='%1.3f')
# GNB
...
np.savetxt('./f1/dd-dummy-gnb.txt', f1_scores_gnb, fmt='%1.3f')
