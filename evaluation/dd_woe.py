...
np.savetxt('./acc/dd-woe-knn.txt', acc_scores_knn, fmt='%1.3f')
# RFC
...
np.savetxt('./acc/dd-woe-rfc.txt', acc_scores_rfc, fmt='%1.3f')
# GNB
...
np.savetxt('./acc/dd-woe-gnb.txt', acc_scores_gnb, fmt='%1.3f')
...
np.savetxt('./f1/dd-woe-knn.txt', f1_scores_knn, fmt='%1.3f')
# RFC
...
np.savetxt('./f1/dd-woe-rfc.txt', f1_scores_rfc, fmt='%1.3f')
# GNB
...
np.savetxt('./f1/dd-woe-gnb.txt', f1_scores_gnb, fmt='%1.3f')
